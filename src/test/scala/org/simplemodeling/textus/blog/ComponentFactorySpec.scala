...
final class ComponentFactorySpec extends AnyWordSpec with Matchers {
  ...
  "ComponentFactory" should {
    ...
    "place the Blog Web app in CAR metadata and Web app resource roots" in {
      ...
      webYaml should include ("component: textus-blog")
      ...
      webYaml should include ("update:\n    layout: edit\n    mode: article")
      webYaml should include ("textus-blog.blog.search-posts:\n    enabled: true\n    layout: reader")
      webYaml should include ("textus-blog.blog.search-my-posts:\n    enabled: true\n    layout: my")
      webYaml should include ("textus-blog.blog.get-post:\n    enabled: true\n    layout: reader")
      webYaml should include ("textus-blog.blog.get-my-post:\n    enabled: true\n    layout: result-edit")
      webYaml should not include "blog-my"
      webYaml should not include "blog-edit"
      webYaml should include ("textus-blog.blog.search-my-posts: protected")
      webYaml should include ("textus-blog.blog.get-my-post: protected")
      ...
      publicHtml should include ("/form/textus-blog/blog/search-posts")
      ...
      publicNavigation should include ("data-jobs-link ${pageContext.jobs.hidden}")
      publicNavigation should include ("data-job-active-badge")
      publicNavigation should include ("${pageContext.jobs.activeCount}")
      publicNavigation should include ("data-job-unconfirmed-badge")
      publicNavigation should include ("${pageContext.jobs.unconfirmedCount}")
      publicNavigation should include ("href=\"/web/blog/jobs\"")
      publicNavigation should include ("title=\"Jobs\"")
      publicNavigation should include ("aria-label=\"Jobs\"")
      publicNavigation should include ("data-notification-indicator ${pageContext.notification.indicatorHidden}")
      publicNavigation should include ("data-notification-badge")
      publicNavigation should include ("${pageContext.notification.unconfirmedCount}")
      publicNavigation should include ("href=\"/web/notifications\"")
      publicNavigation should include ("title=\"Notifications\"")
      publicNavigation should include ("aria-label=\"Notifications\"")
      publicNavigation should not include (">Notifications<")
      ...
      val userNavigation = java.nio.file.Files.readString(root.resolve("src/main/web/WEB-INF/partials/navigation-user.html"))
      userNavigation should include ("href=\"/web/blog/jobs\"")
      userNavigation should include ("title=\"Jobs\"")
      userNavigation should include ("aria-label=\"Jobs\"")
      userNavigation should include ("data-jobs-link")
      userNavigation should include ("data-job-active-badge")
      userNavigation should include ("data-job-unconfirmed-badge")
      userNavigation should not include (">My jobs<")
      userNavigation should include ("data-notification-badge")
      userNavigation should include ("href=\"/web/notifications\"")
      userNavigation should include ("title=\"Notifications\"")
      userNavigation should include ("aria-label=\"Notifications\"")
      userNavigation should not include (">Notifications<")
      val editNavigation = java.nio.file.Files.readString(root.resolve("src/main/web/WEB-INF/partials/navigation-edit.html"))
      editNavigation should include ("href=\"/web/blog/jobs\"")
      editNavigation should include ("title=\"Jobs\"")
      editNavigation should include ("aria-label=\"Jobs\"")
      editNavigation should include ("data-jobs-link")
      editNavigation should include ("data-job-active-badge")
      editNavigation should include ("data-job-unconfirmed-badge")
      editNavigation should not include (">My jobs<")
      editNavigation should include ("data-notification-badge")
      editNavigation should include ("href=\"/web/notifications\"")
      editNavigation should include ("title=\"Notifications\"")
      editNavigation should include ("aria-label=\"Notifications\"")
      editNavigation should not include (">Notifications<")
      myHtml should not include ("btn btn-outline-secondary\" href=\"/web/blog/jobs\"")
      myHtml should include ("/form/textus-blog/blog/search-my-posts")
      ...
      blogJs should not include ("search: \"/form-api/textus-blog/blog/search-posts\"")
      blogJs should not include ("searchMy: \"/form-api/textus-blog/blog/search-my-posts\"")
      blogJs should not include ("debugLabel: \"My posts list\"")
      blogJs should not include ("debugLabel: \"Public post list\"")
      blogJs should not include ("Notification badge summary")
      ...
      blogJs should include ("data-jobs-link")
      blogJs should include ("data-job-active-badge")
      blogJs should include ("data-job-unconfirmed-badge")
      blogJs should include ("data-notification-indicator")
      blogJs should include ("data-notification-badge")
      blogJs should include ("markCurrentHeaderAction")
      blogJs should include ("aria-current")
      blogJs should include ("link.hidden = !authenticated")
      blogJs should include ("renderNotificationBadgeFromServer(authenticated)")
      ...
      blogJs should include ("function renderNotificationBadgeFromServer")
      ...
      publicResultHtml should include ("/form/textus-blog/blog/search-posts/result")
      ...
      userPostHtml should include ("/form/textus-blog/blog/save-editor-post")
      ...
      userResultHtml should include ("/form/textus-blog/blog/search-my-posts/result")
    }
