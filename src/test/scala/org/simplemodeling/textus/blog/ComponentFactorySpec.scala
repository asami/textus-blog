...
final class ComponentFactorySpec extends AnyWordSpec with Matchers {
  ...
  "ComponentFactory" should {
    ...
    "place the Blog Web app in CAR metadata and Web app resource roots" in {
      ...
      blogJs should not include ("search: \"/form-api/blog-component/blog/search-posts\"")
      blogJs should not include ("searchMy: \"/form-api/blog-component/blog/search-my-posts\"")
      ...
      publicResultHtml should include ("/form/blog-component/blog/search-posts/result")
      ...
      userResultHtml should include ("/form/blog-component/blog/search-my-posts/result")
    }
