...
final class ComponentFactorySpec extends AnyWordSpec with Matchers {
  ...
  "ComponentFactory" should {
    ...
    "place the Blog Web app in CAR metadata and Web app resource roots" in {
      ...
      publicNavigation should not include ("data-notification-indicator")
      publicNavigation should not include ("data-notification-badge")
      publicNavigation should not include ("href=\"/web/notifications\"")
      publicNavigation should not include (">Notifications<")
      publicNavigation should not include ("href=\"/web/blog/jobs\"")
